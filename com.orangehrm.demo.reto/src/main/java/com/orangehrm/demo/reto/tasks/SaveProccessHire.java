...
public class SaveProccessHire implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                WaitUntil.the(DemoOrangeHrmRecruitmentPage.INPUT_INTERVIEWEER , isEnabled()).forNoMoreThan(20).seconds(),
                SendKeys.of("a").into(DemoOrangeHrmRecruitmentPage.INPUT_INTERVIEWEER),
